...
## 1️⃣ Threading – Restoran Mutfak Senaryosu
...
## 2️⃣ Multiprocessing – Faktöriyel Hesaplama (CPU-Bound)
...
## 3️⃣ Thread ve Process Arasındaki Bellek Paylaşımı Farkı
...
## 4️⃣ Amdahl Yasası – Sınav Okuma Senaryosu
